...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback((el: HTMLElement) => {
    ...
    const rawSrc = (parent.dataset as any).src || el.querySelector('img')?.src || '';
            ...
            {items.map((it, i) => {
              ...
              return (
                <div
                  ...
                  style={itemStyle}
                >
                  <div className="item__image" role="button" tabIndex={0} onClick={onTileClick} onPointerUp={onTilePointerUp}>
