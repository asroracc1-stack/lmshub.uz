            ...
            >
              ...
              <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
                ...
                <Button 
                  ...
                  variant="outline"
                  className="w-full h-11 sm:h-13 bg-white dark:bg-transparent border-slate-200 dark:border-slate-800 text-slate-700 dark:text-white hover:bg-slate-50 hover:text-slate-900 dark:hover:bg-slate-800 dark:hover:text-white font-semibold rounded-xl flex items-center justify-center gap-3 transition-all text-sm sm:text-base"
                >
                ...
                <Button 
                  onClick={() => window.open("https://t.me/LMSHub_bot", "_blank")}
                  variant="outline"
                  className="w-full h-11 sm:h-13 bg-white dark:bg-transparent border-slate-200 dark:border-slate-800 text-slate-700 dark:text-white hover:bg-[#E8F4FD] hover:text-[#0088cc] hover:border-[#0088cc]/30 dark:hover:bg-[#0088cc]/10 dark:hover:text-[#54A9EB] font-semibold rounded-xl flex items-center justify-center gap-3 transition-all text-sm sm:text-base group"
                >
                  <svg className="h-5 w-5 text-[#0088cc] group-hover:text-[#0088cc] dark:text-[#54A9EB]" viewBox="0 0 24 24" fill="currentColor">
